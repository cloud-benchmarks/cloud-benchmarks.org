...
def main(global_config, **settings):
    ...
    config.add_route('submission_svg', '/submissions/{id:\d+}.svg')
    config.add_route('submission_yaml', '/submissions/{id:\d+}.yaml')
    config.add_route('submission', '/submissions/{id:\d+}')
